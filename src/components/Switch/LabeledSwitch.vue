...
<template>
    <label class="flex justify-between items-center rounded-md">
        {{ props.label }}
        <input v-model="checked" type="checkbox" class="appearance-none peer">
        <span class="w-10 h-6 my-4 flex items-center p-1 bg-highlight rounded-full after:w-4 after:h-4 after:bg-focus
